...
public class main_Calculator extends javax.swing.JFrame {
    ...
    /**
     * Creates new form main_Calculator
     */
    double num,ans;
    int calculation;
    ...
    private void jButton18ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton18ActionPerformed
      ...
      calculation=2;
      jTextField1.setText(" ");
      jLabel1.setText(num + "-");    }//GEN-LAST:event_jButton18ActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(main_Calculator.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
